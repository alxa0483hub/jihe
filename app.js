const levels = [
  {
    ...
    difficulty: "难度：拔高",
    target: "目标：证明线段关系",
    text: "在 △ABC 中，AD 是 BC 边上的中线，AB > AC。点 E 在三角形内部，已知 ∠BAD = ∠CAE。求证：AE = AB - AC。",
    points: { A: [355, 82], B: [132, 402], C: [590, 404], D: [360, 403], E: [430, 250] },
    segments: [["A", "B"], ["A", "C"], ["B", "C"], ["A", "D"], ["A", "E"], ["C", "E"]],
    ...
    proof: [
      ...
      "所以 BF = AC，且 ∠BAF 可以转化为与 ∠CAE 有关的角关系。",
      "利用 ∠BAD = ∠CAE，把 AE 放入新构造的三角形关系中，推出 AE = AB - AC。"
    ],
    decoys: [
      "因为 AB > AC，所以 D 必在线段 AB 的垂直平分线上。",
      "只要连接 BE，就能直接得到 △ABE ≌ △ACE。"
    ],
    tags: ["倍长中线", "构造全等", "线段差", "把隐藏三角形补出来"],
    hints: [
      "中线给的是 BD = DC，但目标含 AB - AC，说明要把 AC 搬到 AB 附近。",
      "遇到中线和线段差，优先试倍长中线，把一半图形旋到另一侧。"
    ]
  },
  {
    title: "角平分线：外部等腰构造",
